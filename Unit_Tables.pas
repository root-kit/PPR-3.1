  ...
  If Connect.Checked then
    begin
      ...
      case PageControl_Join.TabIndex of
        0:  begin
              CaptionEdit :='Добавление в Таблицу ППР';
              Form_Edit_ppr.Show;
        end;
        1:  begin
              CaptionEdit :='Добавление в Таблицу Работы на Оборудовании';
              Form_Edit_ef.Show;
        end;
        2:  CaptionEdit :='Добавление в Таблице ППР';
      end;
    end;
end;
...
begin
  If Connect.Checked then
    begin
      ...
      case PageControl_Join.TabIndex of
        0:  begin
              CaptionEdit :='Изменение в Таблице ППР';
              Form_Edit_ppr.Show;
        end;
        1:  begin
              CaptionEdit :='Изменение в Таблице Работы на Оборудовании';
              Form_Edit_ef.Show;
        end;
        2:  CaptionEdit :='Изменение в Таблице ППР';
      end;
    end;
end;
...
begin
  If Connect.Checked then
    begin
      i:= MessageDlg('Вы действительно хотите удалить?',mtWarning, mbYesNo, 0);
      Case i of
